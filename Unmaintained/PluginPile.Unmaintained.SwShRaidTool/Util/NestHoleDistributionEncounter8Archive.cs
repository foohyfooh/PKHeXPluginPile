...
namespace PluginPile.Unmaintained.SwShRaidTool
{
    ...
    public struct NestHoleDistributionEncounter8Archive : IFlatbufferObject
    {
        ...
        public PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table? Tables(int j) { int o = __p.__offset(4); return o != 0 ? (PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table?)(new PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int TablesLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Archive> CreateNestHoleDistributionEncounter8Archive(FlatBufferBuilder builder,
        ...
        public static VectorOffset CreateTablesVector(FlatBufferBuilder builder, Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateTablesVectorBlock(FlatBufferBuilder builder, Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static void StartTablesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
        public static Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Archive> EndNestHoleDistributionEncounter8Archive(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Archive>(o);
        }
        public static void FinishNestHoleDistributionEncounter8ArchiveBuffer(FlatBufferBuilder builder, Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Archive> offset) { builder.Finish(offset.Value); }
        public static void FinishSizePrefixedNestHoleDistributionEncounter8ArchiveBuffer(FlatBufferBuilder builder, Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Archive> offset) { builder.FinishSizePrefixed(offset.Value); }
    };
    ...
    public struct NestHoleDistributionEncounter8Table : IFlatbufferObject
    {
        ...
        public PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8? Entries(int j) { int o = __p.__offset(12); return o != 0 ? (PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8?)(new PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int EntriesLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table> CreateNestHoleDistributionEncounter8Table(FlatBufferBuilder builder,
            ulong TableID = 0,
            uint GameVersion = 0,
            sbyte Field_02 = 0,
            sbyte Field_03 = 0,
        ...
        public static VectorOffset CreateEntriesVector(FlatBufferBuilder builder, Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateEntriesVectorBlock(FlatBufferBuilder builder, Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static void StartEntriesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
        public static Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table> EndNestHoleDistributionEncounter8Table(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8Table>(o);
        }
    };
  ...
  public Span<uint> GetProbabilitiesBytes() { return __p.__vector_as_span<uint>(34, 4); }
        ...
        public static Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8> CreateNestHoleDistributionEncounter8(FlatBufferBuilder builder,
            uint EntryIndex = 0,
            uint Species = 0,
            uint AltForm = 0,
            uint Level = 0,
        ...
        public static Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8> EndNestHoleDistributionEncounter8(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<PluginPile.Unmaintained.SwShRaidTool.NestHoleDistributionEncounter8>(o);
        }
    };
