...
namespace PluginPile.SortingPlugin {
  class Gen9_Paldea : SortingBase {
    ...
    private static readonly Dictionary<Species, int> PaldeaDex = new Dictionary<Species, int>() {
    ...
    private static readonly Dictionary<Species, int> KitakamiDex = new Dictionary<Species, int>() {
      {Species.Spinarak, 1},
      {Species.Ariados, 2},
      {Species.Yanma, 3},
      {Species.Yanmega, 4},
      ...
      {(Species) 1012 /*Species.Poltchageist*/, 76},
      {(Species) 1013 /*Species.Sinistcha*/, 77},
      ...
      {Species.Indeedee, 193},
      {Species.Basculin, 194},
      {Species.Basculegion, 195},
      {Species.Ursaluna, 196},
      {(Species) 1014 /*Species.Okidogi*/, 197},
      {(Species) 1015 /*Species.Munkidori*/, 198},
      {(Species) 1016 /*Species.Fezandipiti*/, 199},
      {(Species) 1017 /*Species.Ogerpon*/, 200},
    };
    ...
    public static Func<PKM, IComparable>[] GetSortFunctions() {
      return GenerateSortingFunctions(new Dictionary<Species, int>[] { PaldeaDex, KitakamiDex });
    }
