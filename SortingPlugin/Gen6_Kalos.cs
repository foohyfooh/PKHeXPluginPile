...
namespace PluginPile.SortingPlugin {
  class Gen6_Kalos : SortingBase {
    ...
    private static readonly Dictionary<SpeciesForm, int> CentralKalosDex = new Dictionary<SpeciesForm, int>() {
      {Species.Chespin, 1},
      {Species.Quilladin, 2},
      ...
      {Species.Pidgeot, 19},
      {(Species.Scatterbug, 0), 20},
      {(Species.Scatterbug, 1), 20},
      {(Species.Scatterbug, 2), 20},
      {(Species.Scatterbug, 3), 20},
      {(Species.Scatterbug, 4), 20},
      {(Species.Scatterbug, 5), 20},
      {(Species.Scatterbug, 6), 20},
      {(Species.Scatterbug, 7), 20},
      {(Species.Scatterbug, 8), 20},
      {(Species.Scatterbug, 9), 20},
      {(Species.Scatterbug, 10), 20},
      {(Species.Scatterbug, 11), 20},
      {(Species.Scatterbug, 12), 20},
      {(Species.Scatterbug, 13), 20},
      {(Species.Scatterbug, 14), 20},
      {(Species.Scatterbug, 15), 20},
      {(Species.Scatterbug, 16), 20},
      {(Species.Scatterbug, 17), 20},
      {(Species.Scatterbug, 18), 20},
      {(Species.Scatterbug, 19), 20},
      {(Species.Spewpa, 0), 21},
      {(Species.Spewpa, 1), 21},
      {(Species.Spewpa, 2), 21},
      {(Species.Spewpa, 3), 21},
      ...
      {(Species.Spewpa, 8), 21},
      {(Species.Spewpa, 9), 21},
      {(Species.Spewpa, 10), 21},
      {(Species.Spewpa, 11), 21},
      {(Species.Spewpa, 12), 21},
      {(Species.Spewpa, 13), 21},
      {(Species.Spewpa, 14), 21},
      {(Species.Spewpa, 15), 21},
      {(Species.Spewpa, 16), 21},
      {(Species.Spewpa, 17), 21},
      {(Species.Spewpa, 18), 21},
      {(Species.Spewpa, 19), 21},
      {(Species.Vivillon, 0), 22},
      {(Species.Vivillon, 1), 22},
      {(Species.Vivillon, 2), 22},
      {(Species.Vivillon, 3), 22},
      {(Species.Vivillon, 4), 22},
      {(Species.Vivillon, 5), 22},
      {(Species.Vivillon, 6), 22},
      {(Species.Vivillon, 7), 22},
      {(Species.Vivillon, 8), 22},
      {(Species.Vivillon, 9), 22},
      {(Species.Vivillon, 10), 22},
      {(Species.Vivillon, 11), 22},
      {(Species.Vivillon, 12), 22},
      {(Species.Vivillon, 13), 22},
      {(Species.Vivillon, 14), 22},
      {(Species.Vivillon, 15), 22},
      {(Species.Vivillon, 16), 22},
      {(Species.Vivillon, 17), 22},
      {(Species.Vivillon, 18), 22},
      {(Species.Vivillon, 19), 22},
      {Species.Caterpie, 23},
      {Species.Metapod, 24},
      ...
      {(Species.Burmy, 1), 44},
      {(Species.Burmy, 2), 44},
      {(Species.Wormadam, 0), 45},
      {(Species.Wormadam, 1), 45},
      {(Species.Wormadam, 2), 45},
      {(Species.Mothim, 0), 46},
      {(Species.Mothim, 1), 46},
      {(Species.Mothim, 2), 46},
      {Species.Surskit, 47},
      ...
      {Species.Gallade, 67},
      {(Species.Flabébé, 0), 68},
      {(Species.Flabébé, 1), 68},
      {(Species.Flabébé, 2), 68},
      {(Species.Flabébé, 3), 68},
      {(Species.Flabébé, 4), 68},
      {(Species.Floette, 0), 69},
      {(Species.Floette, 1), 69},
      {(Species.Floette, 2), 69},
      {(Species.Floette, 3), 69},
      {(Species.Floette, 4), 69},
      {(Species.Floette, 5), 69},
      {(Species.Florges, 0), 70},
      {(Species.Florges, 1), 70},
      {(Species.Florges, 2), 70},
      {(Species.Florges, 3), 70},
      {(Species.Florges, 4), 70},
      {Species.Budew, 71},
      {Species.Roselia, 72},
      {Species.Roserade, 73},
      {Species.Ledyba, 74},
      ...
      {Species.Pancham, 91},
      {Species.Pangoro, 92},
      {(Species.Furfrou, 0), 93},
      {(Species.Furfrou, 1), 93},
      {(Species.Furfrou, 2), 93},
      {(Species.Furfrou, 3), 93},
      {(Species.Furfrou, 4), 93},
      {(Species.Furfrou, 5), 93},
      {(Species.Furfrou, 6), 93},
      {(Species.Furfrou, 7), 93},
      {(Species.Furfrou, 8), 93},
      {(Species.Furfrou, 9), 93},
      {Species.Doduo, 94},
      {Species.Dodrio, 95},
      {Species.Plusle, 96},
      {Species.Minun, 97},
      ...
      {Species.Espurr, 114},
      {(Species.Meowstic, 0), 115},
      {(Species.Meowstic, 1), 115},
      {Species.Kecleon, 116},
      {Species.Honedge, 117},
      {Species.Doublade, 118},
      {(Species.Aegislash, 0), 119},
      {(Species.Aegislash, 1), 119},
    ...
    private static readonly Dictionary<SpeciesForm, int> CostalKalosDex = new Dictionary<SpeciesForm, int>() {
      {Species.Drifloon, 1},
      {Species.Drifblim, 2},
      {Species.Mienfoo, 3},
      {Species.Mienshao, 4},
    ...
    private static readonly Dictionary<SpeciesForm, int> MountainKalosDex = new Dictionary<SpeciesForm, int>() {
      {Species.Diglett, 1},
      {Species.Dugtrio, 2},
      {Species.Trapinch, 3},
      {Species.Vibrava, 4},
      ...
      {Species.Buizel, 58},
      {Species.Floatzel, 59},
      {(Species.Basculin, 0), 60},
      {(Species.Basculin, 1), 60},
      {Species.Phantump, 61},
      {Species.Trevenant, 62},
      {(Species.Pumpkaboo, 0), 63},
      {(Species.Pumpkaboo, 1), 63},
      {(Species.Pumpkaboo, 2), 63},
      {(Species.Pumpkaboo, 3), 63},
      {(Species.Gourgeist, 0), 64},
      {(Species.Gourgeist, 1), 64},
      {(Species.Gourgeist, 2), 64},
      {(Species.Gourgeist, 3), 64},
      {Species.Litwick, 65},
      {Species.Lampent, 66},
      ...
      {Species.Xerneas, 148},
      {Species.Yveltal, 149},
      {(Species.Zygarde, 0), 150},
      {(Species.Zygarde, 1), 150},
      {(Species.Zygarde, 2), 150},
      {Species.Mewtwo, 151},
    };
