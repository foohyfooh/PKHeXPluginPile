...
namespace PluginPile.SortingPlugin {
  class Gen5_Unova : SortingBase {
    ...
    private static readonly Dictionary<SpeciesForm, int> BWdex = new Dictionary<SpeciesForm, int>() {
      {Species.Victini, 0},
      {Species.Snivy, 1},
      {Species.Servine, 2},
      {Species.Serperior, 3},
      ...
      {(Species.Basculin, 0), 56},
      {(Species.Basculin, 1), 56},
      {Species.Sandile, 57},
      {Species.Krokorok, 58},
      {Species.Krookodile, 59},
      {Species.Darumaka, 60},
      {(Species.Darmanitan, 0), 61},
      {(Species.Darmanitan, 1), 61},
      {Species.Maractus, 62},
      {Species.Dwebble, 63},
      {Species.Crustle, 64},
      {Species.Scraggy, 65},
      ...
      {(Species.Deerling, 0), 91},
      {(Species.Deerling, 1), 91},
      {(Species.Deerling, 2), 91},
      {(Species.Deerling, 3), 91},
      {(Species.Sawsbuck, 0), 92},
      {(Species.Sawsbuck, 1), 92},
      {(Species.Sawsbuck, 2), 92},
      {(Species.Sawsbuck, 3), 92},
      {Species.Emolga, 93},
      ...
      {(Species.Tornadus, 0), 147},
      {(Species.Tornadus, 1), 147},
      {(Species.Thundurus, 0), 148},
      {(Species.Thundurus, 1), 148},
      {Species.Reshiram, 149},
      {Species.Zekrom, 150},
      {(Species.Landorus, 0), 151},
      {(Species.Landorus, 1), 151},
      {(Species.Kyurem, 0), 152},
      {(Species.Kyurem, 1), 152},
      {(Species.Kyurem, 2), 152},
      {(Species.Keldeo, 0), 153},
      {(Species.Keldeo, 1), 153},
      {(Species.Meloetta, 0), 154},
      {(Species.Meloetta, 1), 154},
      {(Species.Genesect, 0), 155},
      {(Species.Genesect, 1), 155},
      {(Species.Genesect, 2), 155},
      {(Species.Genesect, 3), 155},
      {(Species.Genesect, 4), 155},
    };

    private static readonly Dictionary<SpeciesForm, int> B2W2dex = new Dictionary<SpeciesForm, int>() {
      {Species.Victini, 0},
      {Species.Snivy, 1},
      {Species.Servine, 2},
      {Species.Serperior, 3},
      ...
      {(Species.Darmanitan, 0), 103},
      {(Species.Darmanitan, 1), 103},
      {(Species.Basculin, 0), 104},
      {(Species.Basculin, 1), 104},
      ...
      {(Species.Deerling, 0), 159},
      {(Species.Deerling, 1), 159},
      {(Species.Deerling, 2), 159},
      {(Species.Deerling, 3), 159},
      {(Species.Sawsbuck, 0), 160},
      {(Species.Sawsbuck, 1), 160},
      {(Species.Sawsbuck, 2), 160},
      {(Species.Sawsbuck, 3), 160},
      {Species.Foongus, 161},
      {Species.Amoonguss, 162},
      {(Species.Castform, 0), 163},
      {(Species.Castform, 1), 163},
      {(Species.Castform, 2), 163},
      {(Species.Castform, 3), 163},
      ...
      {(Species.Tornadus, 0), 198},
      {(Species.Tornadus, 1), 198},
      {(Species.Thundurus, 0), 199},
      {(Species.Thundurus, 1), 199},
      {(Species.Landorus, 0), 200},
      {(Species.Landorus, 1), 200},
      {Species.Skorupi, 201},
      {Species.Drapion, 202},
      ...
      {Species.Zekrom, 296},
      {(Species.Kyurem, 0), 297},
      {(Species.Kyurem, 1), 297},
      {(Species.Kyurem, 2), 297},
      {(Species.Keldeo, 0), 298},
      {(Species.Keldeo, 1), 298},
      {(Species.Meloetta, 0), 299},
      {(Species.Meloetta, 1), 299},
      {(Species.Genesect, 0), 300},
      {(Species.Genesect, 1), 300},
      {(Species.Genesect, 2), 300},
      {(Species.Genesect, 3), 300},
      {(Species.Genesect, 4), 300},
    };
