...
Copy-Item -Path "bin\x64\Release\net9.0-windows\publish\PluginPile.*.dll" -Destination "bin\Build\Individual" -Exclude "PluginPile.Common.dll","PluginPile.Unmaintained.*.dll"
Copy-Item -Path "bin\x64\Release\net9.0-windows\publish\PluginPile.dll" -Destination "bin\Build"
New-Item -Path "bin\" -Name "Build\Unmaintained" -ItemType "directory"
Copy-Item -Path "bin\x64\Release\net9.0-windows\publish\PluginPile.Unmaintained.*.dll" -Destination "bin\Build\Unmaintained"
